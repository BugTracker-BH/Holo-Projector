...
execute if score #FILL_H holo.tmp matches 5..9 run data modify storage holo:m color set value -256
execute if score #FILL_H holo.tmp matches 10.. run data modify storage holo:m color set value -65536
