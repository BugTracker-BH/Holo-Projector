# holo:text/render_single_line — render msg at adaptive scale (msg fits one line)
scoreboard players operation #HSCALE holo.tmp = #COLS holo.v
scoreboard players remove #HSCALE holo.tmp 4
scoreboard players set #SIXA holo.v 6
scoreboard players operation #HNEED holo.tmp = #MSGLEN holo.tmp
scoreboard players operation #HNEED holo.tmp *= #SIXA holo.v
...
scoreboard players operation #TWIDTH holo.tmp *= #SIXA holo.v
