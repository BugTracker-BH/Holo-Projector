...
scoreboard players remove #CD_VALUE holo.tmp 1
execute if score #CD_VALUE holo.tmp matches ..0 run function holo:countdown/end
execute if score #CD_VALUE holo.tmp matches ..0 run return 0
